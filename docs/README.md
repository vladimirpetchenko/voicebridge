...
- **Главное окно** — лаунчер: список проектов (запуск/остановка серверов
  ...
  Клик по сессии открывает окно чата.
- **Окно чата** (по одному на сессию) — основной интерфейс общения: сверху
  ...
  markdown), инструменты, запросы действий (разрешения/вопросы), история
  сессии. Внизу — панель ввода: текстовое поле + кнопка отправки + голосовая
...
Рядом — текстовое поле: сообщение можно набрать и отправить кнопкой ➤ или
Enter.
